...
class PurchaseInvoice(BaseModel):
    """
    Purchase_Invoice Table Model Class
...
class PurchaseInvoiceLineitems(BaseModel):
    """
    Purchase Invoice Table Model Class
    ...
    invoice_id = models.ForeignKey(PurchaseInvoice, on_delete=models.PROTECT, help_text='Reference to Invoice model')
...
class JournalEntry(BaseModel):
    """
    Journal Entry Table Model Class
...
class JournalEntryLineItem(BaseModel):
    """
    Journal Entry Line Item Table Model Class
