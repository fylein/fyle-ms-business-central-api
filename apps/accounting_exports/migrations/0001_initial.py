    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', ms_business_central_api.models.fields.StringOptionsField(choices=[('INVOICES', 'INVOICES'), ('DIRECT_COST', 'DIRECT_COST'), ('FETCHING_REIMBURSABLE_EXPENSES', 'FETCHING_REIMBURSABLE_EXPENSES'), ('FETCHING_CREDIT_CARD_EXPENENSES', 'FETCHING_CREDIT_CARD_EXPENENSES')], default='', help_text='Task type', max_length=255, null=True)),
